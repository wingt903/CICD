...
graph TD
    ...
    subgraph Phase 1: ServiceNow Entry Point
        ...
        E --> F[Generate Webhook Payload <br> app_id, middleware_type, env]
    end
    ...
    class G,H,I,J,K,L,M orchestrator;

    %% --- PHASE 3: SECURE CLOUD BAKING ---
    subgraph Phase 3: AWS Systems Manager & Packer Core
        M --> N[Packer Launches Temp EC2 Instance in Private Subnet]
    ...
    subgraph Phase 4: Target State & CMDB Loopback
        ...
        U --> V[GitHub Actions Captures New AMI ID]
        V --> W[Outbound API Patch Call Back to ServiceNow]
        W --> X[Update CMDB CI with New Active AMI ID]
