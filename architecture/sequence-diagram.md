...
sequenceDiagram
    ...
    Note over EvidenceStore,AuditTrail: Auditors access reports via Auditor Export API<br/>(AWS Audit Manager PDF + Athena CSV/JSON).<br/>All report access is logged to CloudTrail.
```
